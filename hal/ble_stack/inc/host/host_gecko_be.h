...
#endif
#ifndef SL_BT_SWAP32
#define SL_BT_SWAP32(val) (((((uint32_t)val) & 0xff000000) >> 24)|\
((((uint32_t)val) & 0x00ff0000) >>  8) |\
((((uint32_t)val) & 0x0000ff00) <<  8) |\
((((uint32_t)val) & 0x000000ff) << 24))
#endif
#ifndef SL_BT_SWAP16
#define SL_BT_SWAP16(val) (((((uint16_t)val) & 0xff00) >>  8) |\
((((uint16_t)val) & 0x000ff) << 8))
#endif
...
#define BGLIB_MSG_ID(HDR) (SL_BT_SWAP32(HDR)&0xffff00f8)
#define BGLIB_MSG_HEADER_LEN (4)
#define BGLIB_MSG_LEN(HDR) (((SL_BT_SWAP32(HDR)&0x7)<<8)|((SL_BT_SWAP32(HDR)&0xff00)>>8))
...
static inline void* gecko_cmd_dfu_reset(uint8 dfu)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_dfu_reset_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_dfu_flash_set_address_rsp_t* gecko_cmd_dfu_flash_set_address(uint32 address)
{
    ...
    gecko_cmd_msg->data.cmd_dfu_flash_set_address.address=SL_BT_SWAP32(address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_dfu_flash_set_address_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_dfu_flash_upload_rsp_t* gecko_cmd_dfu_flash_upload(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_dfu_flash_upload_id+(((1+data_len)&0xff)<<8)+(((1+data_len)&0x700)>>8));
...
static inline struct gecko_msg_dfu_flash_upload_finish_rsp_t* gecko_cmd_dfu_flash_upload_finish()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_dfu_flash_upload_finish_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_system_hello_rsp_t* gecko_cmd_system_hello()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_hello_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline void* gecko_cmd_system_reset(uint8 dfu)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_reset_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_system_get_bt_address_rsp_t* gecko_cmd_system_get_bt_address()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_get_bt_address_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_system_set_bt_address_rsp_t* gecko_cmd_system_set_bt_address(bd_addr address)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_set_bt_address_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_system_set_tx_power_rsp_t* gecko_cmd_system_set_tx_power(int16 power)
{
    ...
    gecko_cmd_msg->data.cmd_system_set_tx_power.power=SL_BT_SWAP16(power);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_set_tx_power_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_system_get_random_data_rsp_t* gecko_cmd_system_get_random_data(uint8 length)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_get_random_data_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_system_halt_rsp_t* gecko_cmd_system_halt(uint8 halt)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_halt_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_system_set_device_name_rsp_t* gecko_cmd_system_set_device_name(uint8 type,uint8 name_len, const uint8* name_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_set_device_name_id+(((2+name_len)&0xff)<<8)+(((2+name_len)&0x700)>>8));
...
static inline struct gecko_msg_system_linklayer_configure_rsp_t* gecko_cmd_system_linklayer_configure(uint8 key,uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_linklayer_configure_id+(((2+data_len)&0xff)<<8)+(((2+data_len)&0x700)>>8));
...
static inline struct gecko_msg_system_get_counters_rsp_t* gecko_cmd_system_get_counters(uint8 reset)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_get_counters_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_system_data_buffer_write_rsp_t* gecko_cmd_system_data_buffer_write(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_data_buffer_write_id+(((1+data_len)&0xff)<<8)+(((1+data_len)&0x700)>>8));
...
static inline struct gecko_msg_system_set_identity_address_rsp_t* gecko_cmd_system_set_identity_address(bd_addr address,uint8 type)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_set_identity_address_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_system_data_buffer_clear_rsp_t* gecko_cmd_system_data_buffer_clear()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_system_data_buffer_clear_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_open_rsp_t* gecko_cmd_le_gap_open(bd_addr address,uint8 address_type)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_open_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_mode_rsp_t* gecko_cmd_le_gap_set_mode(uint8 discover,uint8 connect)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_mode_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_discover_rsp_t* gecko_cmd_le_gap_discover(uint8 mode)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_discover_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_end_procedure_rsp_t* gecko_cmd_le_gap_end_procedure()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_end_procedure_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_adv_parameters_rsp_t* gecko_cmd_le_gap_set_adv_parameters(uint16 interval_min,uint16 interval_max,uint8 channel_map)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_adv_parameters.interval_min=SL_BT_SWAP16(interval_min);
    gecko_cmd_msg->data.cmd_le_gap_set_adv_parameters.interval_max=SL_BT_SWAP16(interval_max);
    gecko_cmd_msg->data.cmd_le_gap_set_adv_parameters.channel_map=(channel_map);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_adv_parameters_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_conn_parameters_rsp_t* gecko_cmd_le_gap_set_conn_parameters(uint16 min_interval,uint16 max_interval,uint16 latency,uint16 timeout)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_conn_parameters.min_interval=SL_BT_SWAP16(min_interval);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_parameters.max_interval=SL_BT_SWAP16(max_interval);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_parameters.latency=SL_BT_SWAP16(latency);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_parameters.timeout=SL_BT_SWAP16(timeout);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_conn_parameters_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_scan_parameters_rsp_t* gecko_cmd_le_gap_set_scan_parameters(uint16 scan_interval,uint16 scan_window,uint8 active)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_scan_parameters.scan_interval=SL_BT_SWAP16(scan_interval);
    gecko_cmd_msg->data.cmd_le_gap_set_scan_parameters.scan_window=SL_BT_SWAP16(scan_window);
    gecko_cmd_msg->data.cmd_le_gap_set_scan_parameters.active=(active);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_scan_parameters_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_adv_data_rsp_t* gecko_cmd_le_gap_set_adv_data(uint8 scan_rsp,uint8 adv_data_len, const uint8* adv_data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_adv_data_id+(((2+adv_data_len)&0xff)<<8)+(((2+adv_data_len)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_adv_timeout_rsp_t* gecko_cmd_le_gap_set_adv_timeout(uint8 maxevents)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_adv_timeout_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_conn_phy_rsp_t* gecko_cmd_le_gap_set_conn_phy(uint8 preferred_phy,uint8 accepted_phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_conn_phy_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_bt5_set_mode_rsp_t* gecko_cmd_le_gap_bt5_set_mode(uint8 handle,uint8 discover,uint8 connect,uint16 maxevents,uint8 address_type)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_bt5_set_mode.maxevents=SL_BT_SWAP16(maxevents);
    gecko_cmd_msg->data.cmd_le_gap_bt5_set_mode.address_type=(address_type);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_bt5_set_mode_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_bt5_set_adv_parameters_rsp_t* gecko_cmd_le_gap_bt5_set_adv_parameters(uint8 handle,uint16 interval_min,uint16 interval_max,uint8 channel_map,uint8 report_scan)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_bt5_set_adv_parameters.interval_min=SL_BT_SWAP16(interval_min);
    gecko_cmd_msg->data.cmd_le_gap_bt5_set_adv_parameters.interval_max=SL_BT_SWAP16(interval_max);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_bt5_set_adv_parameters_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_bt5_set_adv_data_rsp_t* gecko_cmd_le_gap_bt5_set_adv_data(uint8 handle,uint8 scan_rsp,uint8 adv_data_len, const uint8* adv_data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_bt5_set_adv_data_id+(((3+adv_data_len)&0xff)<<8)+(((3+adv_data_len)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_privacy_mode_rsp_t* gecko_cmd_le_gap_set_privacy_mode(uint8 privacy,uint8 interval)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_privacy_mode_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_advertise_timing_rsp_t* gecko_cmd_le_gap_set_advertise_timing(uint8 handle,uint32 interval_min,uint32 interval_max,uint16 duration,uint8 maxevents)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_advertise_timing.interval_min=SL_BT_SWAP32(interval_min);
    gecko_cmd_msg->data.cmd_le_gap_set_advertise_timing.interval_max=SL_BT_SWAP32(interval_max);
    gecko_cmd_msg->data.cmd_le_gap_set_advertise_timing.duration=SL_BT_SWAP16(duration);
    gecko_cmd_msg->data.cmd_le_gap_set_advertise_timing.maxevents=(maxevents);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_advertise_timing_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_advertise_channel_map_rsp_t* gecko_cmd_le_gap_set_advertise_channel_map(uint8 handle,uint8 channel_map)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_advertise_channel_map_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_advertise_report_scan_request_rsp_t* gecko_cmd_le_gap_set_advertise_report_scan_request(uint8 handle,uint8 report_scan_req)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_advertise_report_scan_request_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_advertise_phy_rsp_t* gecko_cmd_le_gap_set_advertise_phy(uint8 handle,uint8 primary_phy,uint8 secondary_phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_advertise_phy_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_advertise_configuration_rsp_t* gecko_cmd_le_gap_set_advertise_configuration(uint8 handle,uint32 configurations)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_advertise_configuration.configurations=SL_BT_SWAP32(configurations);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_advertise_configuration_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_clear_advertise_configuration_rsp_t* gecko_cmd_le_gap_clear_advertise_configuration(uint8 handle,uint32 configurations)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_clear_advertise_configuration.configurations=SL_BT_SWAP32(configurations);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_clear_advertise_configuration_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_start_advertising_rsp_t* gecko_cmd_le_gap_start_advertising(uint8 handle,uint8 discover,uint8 connect)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_start_advertising_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_stop_advertising_rsp_t* gecko_cmd_le_gap_stop_advertising(uint8 handle)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_stop_advertising_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_discovery_timing_rsp_t* gecko_cmd_le_gap_set_discovery_timing(uint8 phys,uint16 scan_interval,uint16 scan_window)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_discovery_timing.scan_interval=SL_BT_SWAP16(scan_interval);
    gecko_cmd_msg->data.cmd_le_gap_set_discovery_timing.scan_window=SL_BT_SWAP16(scan_window);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_discovery_timing_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_discovery_type_rsp_t* gecko_cmd_le_gap_set_discovery_type(uint8 phys,uint8 scan_type)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_discovery_type_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_start_discovery_rsp_t* gecko_cmd_le_gap_start_discovery(uint8 scanning_phy,uint8 mode)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_start_discovery_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_data_channel_classification_rsp_t* gecko_cmd_le_gap_set_data_channel_classification(uint8 channel_map_len, const uint8* channel_map_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_data_channel_classification_id+(((1+channel_map_len)&0xff)<<8)+(((1+channel_map_len)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_connect_rsp_t* gecko_cmd_le_gap_connect(bd_addr address,uint8 address_type,uint8 initiating_phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_connect_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_advertise_tx_power_rsp_t* gecko_cmd_le_gap_set_advertise_tx_power(uint8 handle,int16 power)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_advertise_tx_power.power=SL_BT_SWAP16(power);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_advertise_tx_power_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_discovery_extended_scan_response_rsp_t* gecko_cmd_le_gap_set_discovery_extended_scan_response(uint8 enable)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_discovery_extended_scan_response_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_start_periodic_advertising_rsp_t* gecko_cmd_le_gap_start_periodic_advertising(uint8 handle,uint16 interval_min,uint16 interval_max,uint32 flags)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_start_periodic_advertising.interval_min=SL_BT_SWAP16(interval_min);
    gecko_cmd_msg->data.cmd_le_gap_start_periodic_advertising.interval_max=SL_BT_SWAP16(interval_max);
    gecko_cmd_msg->data.cmd_le_gap_start_periodic_advertising.flags=SL_BT_SWAP32(flags);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_start_periodic_advertising_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_stop_periodic_advertising_rsp_t* gecko_cmd_le_gap_stop_periodic_advertising(uint8 handle)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_stop_periodic_advertising_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_long_advertising_data_rsp_t* gecko_cmd_le_gap_set_long_advertising_data(uint8 handle,uint8 packet_type)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_long_advertising_data_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_enable_whitelisting_rsp_t* gecko_cmd_le_gap_enable_whitelisting(uint8 enable)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_enable_whitelisting_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_gap_set_conn_timing_parameters_rsp_t* gecko_cmd_le_gap_set_conn_timing_parameters(uint16 min_interval,uint16 max_interval,uint16 latency,uint16 timeout,uint16 min_ce_length,uint16 max_ce_length)
{
    ...
    gecko_cmd_msg->data.cmd_le_gap_set_conn_timing_parameters.min_interval=SL_BT_SWAP16(min_interval);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_timing_parameters.max_interval=SL_BT_SWAP16(max_interval);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_timing_parameters.latency=SL_BT_SWAP16(latency);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_timing_parameters.timeout=SL_BT_SWAP16(timeout);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_timing_parameters.min_ce_length=SL_BT_SWAP16(min_ce_length);
    gecko_cmd_msg->data.cmd_le_gap_set_conn_timing_parameters.max_ce_length=SL_BT_SWAP16(max_ce_length);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_gap_set_conn_timing_parameters_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_sync_open_rsp_t* gecko_cmd_sync_open(uint8 adv_sid,uint16 skip,uint16 timeout,bd_addr address,uint8 address_type)
{
    ...
    gecko_cmd_msg->data.cmd_sync_open.skip=SL_BT_SWAP16(skip);
    gecko_cmd_msg->data.cmd_sync_open.timeout=SL_BT_SWAP16(timeout);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sync_open_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_sync_close_rsp_t* gecko_cmd_sync_close(uint8 sync)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sync_close_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_set_parameters_rsp_t* gecko_cmd_le_connection_set_parameters(uint8 connection,uint16 min_interval,uint16 max_interval,uint16 latency,uint16 timeout)
{
    ...
    gecko_cmd_msg->data.cmd_le_connection_set_parameters.min_interval=SL_BT_SWAP16(min_interval);
    gecko_cmd_msg->data.cmd_le_connection_set_parameters.max_interval=SL_BT_SWAP16(max_interval);
    gecko_cmd_msg->data.cmd_le_connection_set_parameters.latency=SL_BT_SWAP16(latency);
    gecko_cmd_msg->data.cmd_le_connection_set_parameters.timeout=SL_BT_SWAP16(timeout);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_set_parameters_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_get_rssi_rsp_t* gecko_cmd_le_connection_get_rssi(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_get_rssi_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_disable_slave_latency_rsp_t* gecko_cmd_le_connection_disable_slave_latency(uint8 connection,uint8 disable)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_disable_slave_latency_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_set_phy_rsp_t* gecko_cmd_le_connection_set_phy(uint8 connection,uint8 phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_set_phy_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_close_rsp_t* gecko_cmd_le_connection_close(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_close_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_set_timing_parameters_rsp_t* gecko_cmd_le_connection_set_timing_parameters(uint8 connection,uint16 min_interval,uint16 max_interval,uint16 latency,uint16 timeout,uint16 min_ce_length,uint16 max_ce_length)
{
    ...
    gecko_cmd_msg->data.cmd_le_connection_set_timing_parameters.min_interval=SL_BT_SWAP16(min_interval);
    gecko_cmd_msg->data.cmd_le_connection_set_timing_parameters.max_interval=SL_BT_SWAP16(max_interval);
    gecko_cmd_msg->data.cmd_le_connection_set_timing_parameters.latency=SL_BT_SWAP16(latency);
    gecko_cmd_msg->data.cmd_le_connection_set_timing_parameters.timeout=SL_BT_SWAP16(timeout);
    gecko_cmd_msg->data.cmd_le_connection_set_timing_parameters.min_ce_length=SL_BT_SWAP16(min_ce_length);
    gecko_cmd_msg->data.cmd_le_connection_set_timing_parameters.max_ce_length=SL_BT_SWAP16(max_ce_length);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_set_timing_parameters_id+(((13)&0xff)<<8)+(((13)&0x700)>>8));
...
static inline struct gecko_msg_le_connection_set_preferred_phy_rsp_t* gecko_cmd_le_connection_set_preferred_phy(uint8 connection,uint8 preferred_phy,uint8 accepted_phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_le_connection_set_preferred_phy_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_gatt_set_max_mtu_rsp_t* gecko_cmd_gatt_set_max_mtu(uint16 max_mtu)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_set_max_mtu.max_mtu=SL_BT_SWAP16(max_mtu);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_set_max_mtu_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_gatt_discover_primary_services_rsp_t* gecko_cmd_gatt_discover_primary_services(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_discover_primary_services_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_gatt_discover_primary_services_by_uuid_rsp_t* gecko_cmd_gatt_discover_primary_services_by_uuid(uint8 connection,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_discover_primary_services_by_uuid_id+(((2+uuid_len)&0xff)<<8)+(((2+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_discover_characteristics_rsp_t* gecko_cmd_gatt_discover_characteristics(uint8 connection,uint32 service)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_discover_characteristics.service=SL_BT_SWAP32(service);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_discover_characteristics_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_gatt_discover_characteristics_by_uuid_rsp_t* gecko_cmd_gatt_discover_characteristics_by_uuid(uint8 connection,uint32 service,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_discover_characteristics_by_uuid.service=SL_BT_SWAP32(service);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_discover_characteristics_by_uuid_id+(((6+uuid_len)&0xff)<<8)+(((6+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_set_characteristic_notification_rsp_t* gecko_cmd_gatt_set_characteristic_notification(uint8 connection,uint16 characteristic,uint8 flags)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_set_characteristic_notification.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_gatt_set_characteristic_notification.flags=(flags);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_set_characteristic_notification_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_gatt_discover_descriptors_rsp_t* gecko_cmd_gatt_discover_descriptors(uint8 connection,uint16 characteristic)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_discover_descriptors.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_discover_descriptors_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_gatt_read_characteristic_value_rsp_t* gecko_cmd_gatt_read_characteristic_value(uint8 connection,uint16 characteristic)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_read_characteristic_value.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_read_characteristic_value_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_gatt_read_characteristic_value_by_uuid_rsp_t* gecko_cmd_gatt_read_characteristic_value_by_uuid(uint8 connection,uint32 service,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_read_characteristic_value_by_uuid.service=SL_BT_SWAP32(service);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_read_characteristic_value_by_uuid_id+(((6+uuid_len)&0xff)<<8)+(((6+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_write_characteristic_value_rsp_t* gecko_cmd_gatt_write_characteristic_value(uint8 connection,uint16 characteristic,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_write_characteristic_value.characteristic=SL_BT_SWAP16(characteristic);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_write_characteristic_value_id+(((4+value_len)&0xff)<<8)+(((4+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_write_characteristic_value_without_response_rsp_t* gecko_cmd_gatt_write_characteristic_value_without_response(uint8 connection,uint16 characteristic,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_write_characteristic_value_without_response.characteristic=SL_BT_SWAP16(characteristic);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_write_characteristic_value_without_response_id+(((4+value_len)&0xff)<<8)+(((4+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_prepare_characteristic_value_write_rsp_t* gecko_cmd_gatt_prepare_characteristic_value_write(uint8 connection,uint16 characteristic,uint16 offset,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_prepare_characteristic_value_write.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_gatt_prepare_characteristic_value_write.offset=SL_BT_SWAP16(offset);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_prepare_characteristic_value_write_id+(((6+value_len)&0xff)<<8)+(((6+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_execute_characteristic_value_write_rsp_t* gecko_cmd_gatt_execute_characteristic_value_write(uint8 connection,uint8 flags)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_execute_characteristic_value_write_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_gatt_send_characteristic_confirmation_rsp_t* gecko_cmd_gatt_send_characteristic_confirmation(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_send_characteristic_confirmation_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_gatt_read_descriptor_value_rsp_t* gecko_cmd_gatt_read_descriptor_value(uint8 connection,uint16 descriptor)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_read_descriptor_value.descriptor=SL_BT_SWAP16(descriptor);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_read_descriptor_value_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_gatt_write_descriptor_value_rsp_t* gecko_cmd_gatt_write_descriptor_value(uint8 connection,uint16 descriptor,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_write_descriptor_value.descriptor=SL_BT_SWAP16(descriptor);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_write_descriptor_value_id+(((4+value_len)&0xff)<<8)+(((4+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_find_included_services_rsp_t* gecko_cmd_gatt_find_included_services(uint8 connection,uint32 service)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_find_included_services.service=SL_BT_SWAP32(service);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_find_included_services_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_gatt_read_multiple_characteristic_values_rsp_t* gecko_cmd_gatt_read_multiple_characteristic_values(uint8 connection,uint8 characteristic_list_len, const uint8* characteristic_list_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_read_multiple_characteristic_values_id+(((2+characteristic_list_len)&0xff)<<8)+(((2+characteristic_list_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_read_characteristic_value_from_offset_rsp_t* gecko_cmd_gatt_read_characteristic_value_from_offset(uint8 connection,uint16 characteristic,uint16 offset,uint16 maxlen)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_read_characteristic_value_from_offset.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_gatt_read_characteristic_value_from_offset.offset=SL_BT_SWAP16(offset);
    gecko_cmd_msg->data.cmd_gatt_read_characteristic_value_from_offset.maxlen=SL_BT_SWAP16(maxlen);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_read_characteristic_value_from_offset_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_gatt_prepare_characteristic_value_reliable_write_rsp_t* gecko_cmd_gatt_prepare_characteristic_value_reliable_write(uint8 connection,uint16 characteristic,uint16 offset,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_prepare_characteristic_value_reliable_write.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_gatt_prepare_characteristic_value_reliable_write.offset=SL_BT_SWAP16(offset);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_prepare_characteristic_value_reliable_write_id+(((6+value_len)&0xff)<<8)+(((6+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_read_attribute_value_rsp_t* gecko_cmd_gatt_server_read_attribute_value(uint16 attribute,uint16 offset)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_read_attribute_value.attribute=SL_BT_SWAP16(attribute);
    gecko_cmd_msg->data.cmd_gatt_server_read_attribute_value.offset=SL_BT_SWAP16(offset);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_read_attribute_value_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_read_attribute_type_rsp_t* gecko_cmd_gatt_server_read_attribute_type(uint16 attribute)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_read_attribute_type.attribute=SL_BT_SWAP16(attribute);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_read_attribute_type_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_write_attribute_value_rsp_t* gecko_cmd_gatt_server_write_attribute_value(uint16 attribute,uint16 offset,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_write_attribute_value.attribute=SL_BT_SWAP16(attribute);
    gecko_cmd_msg->data.cmd_gatt_server_write_attribute_value.offset=SL_BT_SWAP16(offset);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_write_attribute_value_id+(((5+value_len)&0xff)<<8)+(((5+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_send_user_read_response_rsp_t* gecko_cmd_gatt_server_send_user_read_response(uint8 connection,uint16 characteristic,uint8 att_errorcode,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_send_user_read_response.characteristic=SL_BT_SWAP16(characteristic);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_send_user_read_response_id+(((5+value_len)&0xff)<<8)+(((5+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_send_user_write_response_rsp_t* gecko_cmd_gatt_server_send_user_write_response(uint8 connection,uint16 characteristic,uint8 att_errorcode)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_send_user_write_response.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_gatt_server_send_user_write_response.att_errorcode=(att_errorcode);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_send_user_write_response_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_send_characteristic_notification_rsp_t* gecko_cmd_gatt_server_send_characteristic_notification(uint8 connection,uint16 characteristic,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_send_characteristic_notification.characteristic=SL_BT_SWAP16(characteristic);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_send_characteristic_notification_id+(((4+value_len)&0xff)<<8)+(((4+value_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_find_attribute_rsp_t* gecko_cmd_gatt_server_find_attribute(uint16 start,uint8 type_len, const uint8* type_data)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_find_attribute.start=SL_BT_SWAP16(start);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_find_attribute_id+(((3+type_len)&0xff)<<8)+(((3+type_len)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_set_capabilities_rsp_t* gecko_cmd_gatt_server_set_capabilities(uint32 caps,uint32 reserved)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_set_capabilities.caps=SL_BT_SWAP32(caps);
    gecko_cmd_msg->data.cmd_gatt_server_set_capabilities.reserved=SL_BT_SWAP32(reserved);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_set_capabilities_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_gatt_server_set_max_mtu_rsp_t* gecko_cmd_gatt_server_set_max_mtu(uint16 max_mtu)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_set_max_mtu.max_mtu=SL_BT_SWAP16(max_mtu);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_gatt_server_set_max_mtu_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_hardware_set_soft_timer_rsp_t* gecko_cmd_hardware_set_soft_timer(uint32 time,uint8 handle,uint8 single_shot)
{
    ...
    gecko_cmd_msg->data.cmd_hardware_set_soft_timer.time=SL_BT_SWAP32(time);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_hardware_set_soft_timer_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_hardware_get_time_rsp_t* gecko_cmd_hardware_get_time()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_hardware_get_time_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_hardware_set_lazy_soft_timer_rsp_t* gecko_cmd_hardware_set_lazy_soft_timer(uint32 time,uint32 slack,uint8 handle,uint8 single_shot)
{
    ...
    gecko_cmd_msg->data.cmd_hardware_set_lazy_soft_timer.time=SL_BT_SWAP32(time);
    gecko_cmd_msg->data.cmd_hardware_set_lazy_soft_timer.slack=SL_BT_SWAP32(slack);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_hardware_set_lazy_soft_timer_id+(((10)&0xff)<<8)+(((10)&0x700)>>8));
...
static inline struct gecko_msg_flash_ps_erase_all_rsp_t* gecko_cmd_flash_ps_erase_all()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_flash_ps_erase_all_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_flash_ps_save_rsp_t* gecko_cmd_flash_ps_save(uint16 key,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_flash_ps_save.key=SL_BT_SWAP16(key);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_flash_ps_save_id+(((3+value_len)&0xff)<<8)+(((3+value_len)&0x700)>>8));
...
static inline struct gecko_msg_flash_ps_load_rsp_t* gecko_cmd_flash_ps_load(uint16 key)
{
    ...
    gecko_cmd_msg->data.cmd_flash_ps_load.key=SL_BT_SWAP16(key);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_flash_ps_load_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_flash_ps_erase_rsp_t* gecko_cmd_flash_ps_erase(uint16 key)
{
    ...
    gecko_cmd_msg->data.cmd_flash_ps_erase.key=SL_BT_SWAP16(key);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_flash_ps_erase_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_test_dtm_tx_rsp_t* gecko_cmd_test_dtm_tx(uint8 packet_type,uint8 length,uint8 channel,uint8 phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_test_dtm_tx_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_test_dtm_rx_rsp_t* gecko_cmd_test_dtm_rx(uint8 channel,uint8 phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_test_dtm_rx_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_test_dtm_end_rsp_t* gecko_cmd_test_dtm_end()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_test_dtm_end_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_sm_set_bondable_mode_rsp_t* gecko_cmd_sm_set_bondable_mode(uint8 bondable)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_set_bondable_mode_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_sm_configure_rsp_t* gecko_cmd_sm_configure(uint8 flags,uint8 io_capabilities)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_configure_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_sm_store_bonding_configuration_rsp_t* gecko_cmd_sm_store_bonding_configuration(uint8 max_bonding_count,uint8 policy_flags)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_store_bonding_configuration_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_sm_increase_security_rsp_t* gecko_cmd_sm_increase_security(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_increase_security_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_sm_delete_bonding_rsp_t* gecko_cmd_sm_delete_bonding(uint8 bonding)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_delete_bonding_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_sm_delete_bondings_rsp_t* gecko_cmd_sm_delete_bondings()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_delete_bondings_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_sm_enter_passkey_rsp_t* gecko_cmd_sm_enter_passkey(uint8 connection,int32 passkey)
{
    ...
    gecko_cmd_msg->data.cmd_sm_enter_passkey.passkey=SL_BT_SWAP32(passkey);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_enter_passkey_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_sm_passkey_confirm_rsp_t* gecko_cmd_sm_passkey_confirm(uint8 connection,uint8 confirm)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_passkey_confirm_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_sm_set_oob_data_rsp_t* gecko_cmd_sm_set_oob_data(uint8 oob_data_len, const uint8* oob_data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_set_oob_data_id+(((1+oob_data_len)&0xff)<<8)+(((1+oob_data_len)&0x700)>>8));
...
static inline struct gecko_msg_sm_list_all_bondings_rsp_t* gecko_cmd_sm_list_all_bondings()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_list_all_bondings_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_sm_bonding_confirm_rsp_t* gecko_cmd_sm_bonding_confirm(uint8 connection,uint8 confirm)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_bonding_confirm_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_sm_set_debug_mode_rsp_t* gecko_cmd_sm_set_debug_mode()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_set_debug_mode_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_sm_set_passkey_rsp_t* gecko_cmd_sm_set_passkey(int32 passkey)
{
    ...
    gecko_cmd_msg->data.cmd_sm_set_passkey.passkey=SL_BT_SWAP32(passkey);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_set_passkey_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_sm_use_sc_oob_rsp_t* gecko_cmd_sm_use_sc_oob(uint8 enable)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_use_sc_oob_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_sm_set_sc_remote_oob_data_rsp_t* gecko_cmd_sm_set_sc_remote_oob_data(uint8 oob_data_len, const uint8* oob_data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_set_sc_remote_oob_data_id+(((1+oob_data_len)&0xff)<<8)+(((1+oob_data_len)&0x700)>>8));
...
static inline struct gecko_msg_sm_add_to_whitelist_rsp_t* gecko_cmd_sm_add_to_whitelist(bd_addr address,uint8 address_type)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_add_to_whitelist_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_sm_set_minimum_key_size_rsp_t* gecko_cmd_sm_set_minimum_key_size(uint8 minimum_key_size)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_sm_set_minimum_key_size_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_homekit_configure_rsp_t* gecko_cmd_homekit_configure(uint8 i2c_address,uint8 support_display,uint8 hap_attribute_features,uint16 category,uint8 configuration_number,uint16 fast_advert_interval,uint16 fast_advert_timeout,uint32 flag,uint16 broadcast_advert_timeout,uint8 model_name_len, const uint8* model_name_data)
{
    ...
    gecko_cmd_msg->data.cmd_homekit_configure.category=SL_BT_SWAP16(category);
    gecko_cmd_msg->data.cmd_homekit_configure.configuration_number=(configuration_number);
    gecko_cmd_msg->data.cmd_homekit_configure.fast_advert_interval=SL_BT_SWAP16(fast_advert_interval);
    gecko_cmd_msg->data.cmd_homekit_configure.fast_advert_timeout=SL_BT_SWAP16(fast_advert_timeout);
    gecko_cmd_msg->data.cmd_homekit_configure.flag=SL_BT_SWAP32(flag);
    gecko_cmd_msg->data.cmd_homekit_configure.broadcast_advert_timeout=SL_BT_SWAP16(broadcast_advert_timeout);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_configure_id+(((17+model_name_len)&0xff)<<8)+(((17+model_name_len)&0x700)>>8));
...
static inline struct gecko_msg_homekit_advertise_rsp_t* gecko_cmd_homekit_advertise(uint8 enable,uint16 interval_min,uint16 interval_max,uint8 channel_map)
{
    ...
    gecko_cmd_msg->data.cmd_homekit_advertise.interval_min=SL_BT_SWAP16(interval_min);
    gecko_cmd_msg->data.cmd_homekit_advertise.interval_max=SL_BT_SWAP16(interval_max);
    gecko_cmd_msg->data.cmd_homekit_advertise.channel_map=(channel_map);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_advertise_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_homekit_delete_pairings_rsp_t* gecko_cmd_homekit_delete_pairings()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_delete_pairings_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_homekit_check_authcp_rsp_t* gecko_cmd_homekit_check_authcp()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_check_authcp_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_homekit_get_pairing_id_rsp_t* gecko_cmd_homekit_get_pairing_id(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_get_pairing_id_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_homekit_send_write_response_rsp_t* gecko_cmd_homekit_send_write_response(uint8 connection,uint16 characteristic,uint8 status_code)
{
    ...
    gecko_cmd_msg->data.cmd_homekit_send_write_response.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_homekit_send_write_response.status_code=(status_code);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_send_write_response_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_homekit_send_read_response_rsp_t* gecko_cmd_homekit_send_read_response(uint8 connection,uint16 characteristic,uint8 status_code,uint16 attribute_size,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_homekit_send_read_response.characteristic=SL_BT_SWAP16(characteristic);
    gecko_cmd_msg->data.cmd_homekit_send_read_response.status_code=(status_code);
    gecko_cmd_msg->data.cmd_homekit_send_read_response.attribute_size=SL_BT_SWAP16(attribute_size);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_send_read_response_id+(((7+value_len)&0xff)<<8)+(((7+value_len)&0x700)>>8));
...
static inline struct gecko_msg_homekit_gsn_action_rsp_t* gecko_cmd_homekit_gsn_action(uint8 action)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_gsn_action_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_homekit_event_notification_rsp_t* gecko_cmd_homekit_event_notification(uint8 connection,uint16 characteristic,uint8 change_originator,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_homekit_event_notification.characteristic=SL_BT_SWAP16(characteristic);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_event_notification_id+(((5+value_len)&0xff)<<8)+(((5+value_len)&0x700)>>8));
...
static inline struct gecko_msg_homekit_broadcast_action_rsp_t* gecko_cmd_homekit_broadcast_action(uint8 action,uint8 params_len, const uint8* params_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_homekit_broadcast_action_id+(((2+params_len)&0xff)<<8)+(((2+params_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_init_rsp_t* gecko_cmd_mesh_node_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_start_unprov_beaconing_rsp_t* gecko_cmd_mesh_node_start_unprov_beaconing(uint8 bearer)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_start_unprov_beaconing_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_input_oob_request_rsp_rsp_t* gecko_cmd_mesh_node_input_oob_request_rsp(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_input_oob_request_rsp_id+(((1+data_len)&0xff)<<8)+(((1+data_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_uuid_rsp_t* gecko_cmd_mesh_node_get_uuid()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_uuid_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_set_provisioning_data_rsp_t* gecko_cmd_mesh_node_set_provisioning_data(aes_key_128 device_key,aes_key_128 network_key,uint16 netkey_index,uint32 iv_index,uint16 address,uint8 kr_in_progress)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_node_set_provisioning_data.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_node_set_provisioning_data.iv_index=SL_BT_SWAP32(iv_index);
    gecko_cmd_msg->data.cmd_mesh_node_set_provisioning_data.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_node_set_provisioning_data.kr_in_progress=(kr_in_progress);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_set_provisioning_data_id+(((41)&0xff)<<8)+(((41)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_init_oob_rsp_t* gecko_cmd_mesh_node_init_oob(uint8 public_key,uint8 auth_methods,uint16 output_actions,uint8 output_size,uint16 input_actions,uint8 input_size,uint16 oob_location)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_node_init_oob.output_actions=SL_BT_SWAP16(output_actions);
    gecko_cmd_msg->data.cmd_mesh_node_init_oob.output_size=(output_size);
    gecko_cmd_msg->data.cmd_mesh_node_init_oob.input_actions=SL_BT_SWAP16(input_actions);
    gecko_cmd_msg->data.cmd_mesh_node_init_oob.input_size=(input_size);
    gecko_cmd_msg->data.cmd_mesh_node_init_oob.oob_location=SL_BT_SWAP16(oob_location);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_init_oob_id+(((10)&0xff)<<8)+(((10)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_set_ivrecovery_mode_rsp_t* gecko_cmd_mesh_node_set_ivrecovery_mode(uint8 mode)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_set_ivrecovery_mode_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_ivrecovery_mode_rsp_t* gecko_cmd_mesh_node_get_ivrecovery_mode()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_ivrecovery_mode_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_set_adv_event_filter_rsp_t* gecko_cmd_mesh_node_set_adv_event_filter(uint16 mask,uint8 gap_data_type_len, const uint8* gap_data_type_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_node_set_adv_event_filter.mask=SL_BT_SWAP16(mask);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_set_adv_event_filter_id+(((3+gap_data_type_len)&0xff)<<8)+(((3+gap_data_type_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_statistics_rsp_t* gecko_cmd_mesh_node_get_statistics()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_statistics_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_clear_statistics_rsp_t* gecko_cmd_mesh_node_clear_statistics()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_clear_statistics_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_set_net_relay_delay_rsp_t* gecko_cmd_mesh_node_set_net_relay_delay(uint8 min,uint8 max)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_set_net_relay_delay_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_net_relay_delay_rsp_t* gecko_cmd_mesh_node_get_net_relay_delay()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_net_relay_delay_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_ivupdate_state_rsp_t* gecko_cmd_mesh_node_get_ivupdate_state()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_ivupdate_state_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_request_ivupdate_rsp_t* gecko_cmd_mesh_node_request_ivupdate()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_request_ivupdate_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_seq_remaining_rsp_t* gecko_cmd_mesh_node_get_seq_remaining(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_node_get_seq_remaining.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_seq_remaining_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_save_replay_protection_list_rsp_t* gecko_cmd_mesh_node_save_replay_protection_list()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_save_replay_protection_list_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_set_uuid_rsp_t* gecko_cmd_mesh_node_set_uuid(uuid_128 uuid)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_set_uuid_id+(((16)&0xff)<<8)+(((16)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_get_element_address_rsp_t* gecko_cmd_mesh_node_get_element_address(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_node_get_element_address.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_get_element_address_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_static_oob_request_rsp_rsp_t* gecko_cmd_mesh_node_static_oob_request_rsp(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_static_oob_request_rsp_id+(((1+data_len)&0xff)<<8)+(((1+data_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_node_reset_rsp_t* gecko_cmd_mesh_node_reset()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_node_reset_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_init_rsp_t* gecko_cmd_mesh_prov_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_scan_unprov_beacons_rsp_t* gecko_cmd_mesh_prov_scan_unprov_beacons()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_scan_unprov_beacons_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_provision_device_rsp_t* gecko_cmd_mesh_prov_provision_device(uint8 network_id,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_provision_device_id+(((2+uuid_len)&0xff)<<8)+(((2+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_create_network_rsp_t* gecko_cmd_mesh_prov_create_network(uint8 key_len, const uint8* key_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_create_network_id+(((1+key_len)&0xff)<<8)+(((1+key_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_get_dcd_rsp_t* gecko_cmd_mesh_prov_get_dcd(uint16 address,uint8 page)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_get_dcd.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_get_dcd.page=(page);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_get_dcd_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_get_config_rsp_t* gecko_cmd_mesh_prov_get_config(uint16 address,uint16 id,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_get_config.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_get_config.id=SL_BT_SWAP16(id);
    gecko_cmd_msg->data.cmd_mesh_prov_get_config.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_get_config_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_set_config_rsp_t* gecko_cmd_mesh_prov_set_config(uint16 address,uint16 id,uint16 netkey_index,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_set_config.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_set_config.id=SL_BT_SWAP16(id);
    gecko_cmd_msg->data.cmd_mesh_prov_set_config.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_set_config_id+(((7+value_len)&0xff)<<8)+(((7+value_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_create_appkey_rsp_t* gecko_cmd_mesh_prov_create_appkey(uint16 netkey_index,uint8 key_len, const uint8* key_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_create_appkey.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_create_appkey_id+(((3+key_len)&0xff)<<8)+(((3+key_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_oob_pkey_rsp_rsp_t* gecko_cmd_mesh_prov_oob_pkey_rsp(uint8 pkey_len, const uint8* pkey_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_oob_pkey_rsp_id+(((1+pkey_len)&0xff)<<8)+(((1+pkey_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_oob_auth_rsp_rsp_t* gecko_cmd_mesh_prov_oob_auth_rsp(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_oob_auth_rsp_id+(((1+data_len)&0xff)<<8)+(((1+data_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_set_oob_requirements_rsp_t* gecko_cmd_mesh_prov_set_oob_requirements(uint8 public_key,uint8 auth_methods,uint16 output_actions,uint16 input_actions,uint8 min_size,uint8 max_size)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_set_oob_requirements.output_actions=SL_BT_SWAP16(output_actions);
    gecko_cmd_msg->data.cmd_mesh_prov_set_oob_requirements.input_actions=SL_BT_SWAP16(input_actions);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_set_oob_requirements_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_key_refresh_start_rsp_t* gecko_cmd_mesh_prov_key_refresh_start(uint16 netkey_index,uint8 num_appkeys,uint8 appkey_indices_len, const uint8* appkey_indices_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_key_refresh_start.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_key_refresh_start_id+(((4+appkey_indices_len)&0xff)<<8)+(((4+appkey_indices_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_get_key_refresh_blacklist_rsp_t* gecko_cmd_mesh_prov_get_key_refresh_blacklist(uint16 key,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_get_key_refresh_blacklist.key=SL_BT_SWAP16(key);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_get_key_refresh_blacklist_id+(((3+uuid_len)&0xff)<<8)+(((3+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_set_key_refresh_blacklist_rsp_t* gecko_cmd_mesh_prov_set_key_refresh_blacklist(uint16 key,uint8 status,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_set_key_refresh_blacklist.key=SL_BT_SWAP16(key);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_set_key_refresh_blacklist_id+(((4+uuid_len)&0xff)<<8)+(((4+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_appkey_add_rsp_t* gecko_cmd_mesh_prov_appkey_add(uint16 address,uint16 netkey_index,uint16 appkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_add.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_add.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_add.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_appkey_add_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_appkey_delete_rsp_t* gecko_cmd_mesh_prov_appkey_delete(uint16 address,uint16 netkey_index,uint16 appkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_delete.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_delete.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_delete.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_appkey_delete_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_app_bind_rsp_t* gecko_cmd_mesh_prov_model_app_bind(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_bind.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_bind.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_bind.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_bind.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_bind.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_bind.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_app_bind_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_app_unbind_rsp_t* gecko_cmd_mesh_prov_model_app_unbind(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_unbind.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_unbind.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_unbind.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_unbind.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_unbind.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_unbind.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_app_unbind_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_app_get_rsp_t* gecko_cmd_mesh_prov_model_app_get(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_get.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_get.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_app_get.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_app_get_id+(((10)&0xff)<<8)+(((10)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_add_rsp_t* gecko_cmd_mesh_prov_model_sub_add(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_add_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_pub_set_rsp_t* gecko_cmd_mesh_prov_model_pub_set(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id,uint16 pub_address,uint8 ttl,uint8 period,uint8 retrans)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set.pub_address=SL_BT_SWAP16(pub_address);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_pub_set_id+(((17)&0xff)<<8)+(((17)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_provision_gatt_device_rsp_t* gecko_cmd_mesh_prov_provision_gatt_device(uint8 network_id,uint8 connection,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_provision_gatt_device_id+(((3+uuid_len)&0xff)<<8)+(((3+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_ddb_get_rsp_t* gecko_cmd_mesh_prov_ddb_get(uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_ddb_get_id+(((1+uuid_len)&0xff)<<8)+(((1+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_ddb_delete_rsp_t* gecko_cmd_mesh_prov_ddb_delete(uuid_128 uuid)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_ddb_delete_id+(((16)&0xff)<<8)+(((16)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_ddb_add_rsp_t* gecko_cmd_mesh_prov_ddb_add(uuid_128 uuid,aes_key_128 device_key,uint16 netkey_index,uint16 address,uint8 elements)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_ddb_add.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_ddb_add.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_ddb_add.elements=(elements);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_ddb_add_id+(((37)&0xff)<<8)+(((37)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_ddb_list_devices_rsp_t* gecko_cmd_mesh_prov_ddb_list_devices()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_ddb_list_devices_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_network_add_rsp_t* gecko_cmd_mesh_prov_network_add(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_network_add.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_network_add.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_network_add_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_network_delete_rsp_t* gecko_cmd_mesh_prov_network_delete(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_network_delete.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_network_delete.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_network_delete_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_nettx_get_rsp_t* gecko_cmd_mesh_prov_nettx_get(uint16 address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_nettx_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_nettx_get_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_nettx_set_rsp_t* gecko_cmd_mesh_prov_nettx_set(uint16 address,uint8 count,uint8 interval)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_nettx_set.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_nettx_set.count=(count);
    gecko_cmd_msg->data.cmd_mesh_prov_nettx_set.interval=(interval);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_nettx_set_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_del_rsp_t* gecko_cmd_mesh_prov_model_sub_del(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_del_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_add_va_rsp_t* gecko_cmd_mesh_prov_model_sub_add_va(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id,uint8 sub_address_len, const uint8* sub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add_va.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add_va.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add_va.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_add_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_add_va_id+(((11+sub_address_len)&0xff)<<8)+(((11+sub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_del_va_rsp_t* gecko_cmd_mesh_prov_model_sub_del_va(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id,uint8 sub_address_len, const uint8* sub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del_va.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del_va.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del_va.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_del_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_del_va_id+(((11+sub_address_len)&0xff)<<8)+(((11+sub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_set_rsp_t* gecko_cmd_mesh_prov_model_sub_set(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_set_id+(((12)&0xff)<<8)+(((12)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_set_va_rsp_t* gecko_cmd_mesh_prov_model_sub_set_va(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id,uint8 sub_address_len, const uint8* sub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set_va.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set_va.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set_va.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_set_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_set_va_id+(((11+sub_address_len)&0xff)<<8)+(((11+sub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_heartbeat_publication_get_rsp_t* gecko_cmd_mesh_prov_heartbeat_publication_get(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_heartbeat_publication_get_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_heartbeat_publication_set_rsp_t* gecko_cmd_mesh_prov_heartbeat_publication_set(uint16 address,uint16 netkey_index,uint16 publication_address,uint8 count_log,uint8 period_log,uint8 ttl,uint16 features,uint16 publication_netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_set.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_set.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_set.publication_address=SL_BT_SWAP16(publication_address);
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_set.features=SL_BT_SWAP16(features);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_publication_set.publication_netkey_index=SL_BT_SWAP16(publication_netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_heartbeat_publication_set_id+(((13)&0xff)<<8)+(((13)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_heartbeat_subscription_get_rsp_t* gecko_cmd_mesh_prov_heartbeat_subscription_get(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_heartbeat_subscription_get_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_heartbeat_subscription_set_rsp_t* gecko_cmd_mesh_prov_heartbeat_subscription_set(uint16 address,uint16 netkey_index,uint16 subscription_source,uint16 subscription_destination,uint8 period_log)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_set.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_set.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_set.subscription_source=SL_BT_SWAP16(subscription_source);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_set.subscription_destination=SL_BT_SWAP16(subscription_destination);
    gecko_cmd_msg->data.cmd_mesh_prov_heartbeat_subscription_set.period_log=(period_log);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_heartbeat_subscription_set_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_relay_get_rsp_t* gecko_cmd_mesh_prov_relay_get(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_relay_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_relay_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_relay_get_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_relay_set_rsp_t* gecko_cmd_mesh_prov_relay_set(uint16 address,uint16 netkey_index,uint8 relay,uint8 count,uint8 interval)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_relay_set.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_relay_set.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_relay_set_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_reset_node_rsp_t* gecko_cmd_mesh_prov_reset_node(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_reset_node.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_reset_node.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_reset_node_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_appkey_get_rsp_t* gecko_cmd_mesh_prov_appkey_get(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_appkey_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_appkey_get_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_network_get_rsp_t* gecko_cmd_mesh_prov_network_get(uint16 address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_network_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_network_get_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_clear_rsp_t* gecko_cmd_mesh_prov_model_sub_clear(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_clear.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_clear.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_clear.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_clear.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_clear.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_clear_id+(((10)&0xff)<<8)+(((10)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_pub_get_rsp_t* gecko_cmd_mesh_prov_model_pub_get(uint16 address,uint16 elem_address,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_get.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_get.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_get.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_pub_get_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_pub_set_va_rsp_t* gecko_cmd_mesh_prov_model_pub_set_va(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id,uint8 ttl,uint8 period,uint8 retrans,uint8 pub_address_len, const uint8* pub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_pub_set_va_id+(((16+pub_address_len)&0xff)<<8)+(((16+pub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_pub_set_cred_rsp_t* gecko_cmd_mesh_prov_model_pub_set_cred(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id,uint16 pub_address,uint8 ttl,uint8 period,uint8 retrans,uint8 credentials)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_cred.pub_address=SL_BT_SWAP16(pub_address);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_pub_set_cred_id+(((18)&0xff)<<8)+(((18)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_pub_set_va_cred_rsp_t* gecko_cmd_mesh_prov_model_pub_set_va_cred(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id,uint8 ttl,uint8 period,uint8 retrans,uint8 credentials,uint8 pub_address_len, const uint8* pub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va_cred.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va_cred.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va_cred.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va_cred.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va_cred.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_pub_set_va_cred.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_pub_set_va_cred_id+(((17+pub_address_len)&0xff)<<8)+(((17+pub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_model_sub_get_rsp_t* gecko_cmd_mesh_prov_model_sub_get(uint16 address,uint16 elem_address,uint16 netkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_get.elem_address=SL_BT_SWAP16(elem_address);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_get.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_prov_model_sub_get.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_model_sub_get_id+(((10)&0xff)<<8)+(((10)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_friend_timeout_get_rsp_t* gecko_cmd_mesh_prov_friend_timeout_get(uint16 address,uint16 netkey_index,uint16 lpn_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_friend_timeout_get.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_friend_timeout_get.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_friend_timeout_get.lpn_address=SL_BT_SWAP16(lpn_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_friend_timeout_get_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_get_default_configuration_timeout_rsp_t* gecko_cmd_mesh_prov_get_default_configuration_timeout()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_get_default_configuration_timeout_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_set_default_configuration_timeout_rsp_t* gecko_cmd_mesh_prov_set_default_configuration_timeout(uint32 timeout,uint32 lpn_timeout)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_set_default_configuration_timeout.timeout=SL_BT_SWAP32(timeout);
    gecko_cmd_msg->data.cmd_mesh_prov_set_default_configuration_timeout.lpn_timeout=SL_BT_SWAP32(lpn_timeout);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_set_default_configuration_timeout_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_provision_device_with_address_rsp_t* gecko_cmd_mesh_prov_provision_device_with_address(uint8 network_id,uint16 address,uint8 elements,uint8 attention_timer,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_provision_device_with_address.address=SL_BT_SWAP16(address);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_provision_device_with_address_id+(((6+uuid_len)&0xff)<<8)+(((6+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_provision_gatt_device_with_address_rsp_t* gecko_cmd_mesh_prov_provision_gatt_device_with_address(uint8 network_id,uint8 connection,uint16 address,uint8 elements,uint8 attention_timer,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_provision_gatt_device_with_address.address=SL_BT_SWAP16(address);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_provision_gatt_device_with_address_id+(((7+uuid_len)&0xff)<<8)+(((7+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_initialize_network_rsp_t* gecko_cmd_mesh_prov_initialize_network(uint16 address,uint32 ivi)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_initialize_network.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_prov_initialize_network.ivi=SL_BT_SWAP32(ivi);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_initialize_network_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_get_key_refresh_appkey_blacklist_rsp_t* gecko_cmd_mesh_prov_get_key_refresh_appkey_blacklist(uint16 netkey_index,uint16 appkey_index,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_get_key_refresh_appkey_blacklist.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_get_key_refresh_appkey_blacklist.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_get_key_refresh_appkey_blacklist_id+(((5+uuid_len)&0xff)<<8)+(((5+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_set_key_refresh_appkey_blacklist_rsp_t* gecko_cmd_mesh_prov_set_key_refresh_appkey_blacklist(uint16 netkey_index,uint16 appkey_index,uint8 status,uint8 uuid_len, const uint8* uuid_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_prov_set_key_refresh_appkey_blacklist.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_prov_set_key_refresh_appkey_blacklist.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_set_key_refresh_appkey_blacklist_id+(((6+uuid_len)&0xff)<<8)+(((6+uuid_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_prov_stop_scan_unprov_beacons_rsp_t* gecko_cmd_mesh_prov_stop_scan_unprov_beacons()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_prov_stop_scan_unprov_beacons_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_proxy_connect_rsp_t* gecko_cmd_mesh_proxy_connect(uint8 connection)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_proxy_connect_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_proxy_disconnect_rsp_t* gecko_cmd_mesh_proxy_disconnect(uint32 handle)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_proxy_disconnect.handle=SL_BT_SWAP32(handle);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_proxy_disconnect_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_proxy_set_filter_type_rsp_t* gecko_cmd_mesh_proxy_set_filter_type(uint32 handle,uint8 type,uint16 key)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_proxy_set_filter_type.handle=SL_BT_SWAP32(handle);
    gecko_cmd_msg->data.cmd_mesh_proxy_set_filter_type.type=(type);
    gecko_cmd_msg->data.cmd_mesh_proxy_set_filter_type.key=SL_BT_SWAP16(key);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_proxy_set_filter_type_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_mesh_proxy_allow_rsp_t* gecko_cmd_mesh_proxy_allow(uint32 handle,uint16 address,uint16 key)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_proxy_allow.handle=SL_BT_SWAP32(handle);
    gecko_cmd_msg->data.cmd_mesh_proxy_allow.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_proxy_allow.key=SL_BT_SWAP16(key);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_proxy_allow_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_proxy_deny_rsp_t* gecko_cmd_mesh_proxy_deny(uint32 handle,uint16 address,uint16 key)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_proxy_deny.handle=SL_BT_SWAP32(handle);
    gecko_cmd_msg->data.cmd_mesh_proxy_deny.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_proxy_deny.key=SL_BT_SWAP16(key);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_proxy_deny_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_vendor_model_send_rsp_t* gecko_cmd_mesh_vendor_model_send(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint16 destination_address,int8 va_index,uint16 appkey_index,uint8 nonrelayed,uint8 opcode,uint8 final,uint8 payload_len, const uint8* payload_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_vendor_model_send.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_send.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_send.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_send.destination_address=SL_BT_SWAP16(destination_address);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_send.va_index=(va_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_send.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_vendor_model_send_id+(((15+payload_len)&0xff)<<8)+(((15+payload_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_vendor_model_set_publication_rsp_t* gecko_cmd_mesh_vendor_model_set_publication(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint8 opcode,uint8 final,uint8 payload_len, const uint8* payload_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_vendor_model_set_publication.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_set_publication.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_set_publication.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_vendor_model_set_publication_id+(((9+payload_len)&0xff)<<8)+(((9+payload_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_vendor_model_clear_publication_rsp_t* gecko_cmd_mesh_vendor_model_clear_publication(uint16 elem_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_vendor_model_clear_publication.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_clear_publication.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_clear_publication.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_vendor_model_clear_publication_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_vendor_model_publish_rsp_t* gecko_cmd_mesh_vendor_model_publish(uint16 elem_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_vendor_model_publish.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_publish.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_publish.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_vendor_model_publish_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_vendor_model_init_rsp_t* gecko_cmd_mesh_vendor_model_init(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint8 publish,uint8 opcodes_len, const uint8* opcodes_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_vendor_model_init.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_init.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_init.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_vendor_model_init_id+(((8+opcodes_len)&0xff)<<8)+(((8+opcodes_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_vendor_model_deinit_rsp_t* gecko_cmd_mesh_vendor_model_deinit(uint16 elem_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_vendor_model_deinit.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_deinit.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_vendor_model_deinit.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_vendor_model_deinit_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_get_rsp_t* gecko_cmd_mesh_health_client_get(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint16 vendor_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_get.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_get.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_get.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_get.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_get_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_clear_rsp_t* gecko_cmd_mesh_health_client_clear(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint16 vendor_id,uint8 reliable)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_clear.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_clear.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_clear.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_clear.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_health_client_clear.reliable=(reliable);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_clear_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_test_rsp_t* gecko_cmd_mesh_health_client_test(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 test_id,uint16 vendor_id,uint8 reliable)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_test.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_test.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_test.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_test.test_id=(test_id);
    gecko_cmd_msg->data.cmd_mesh_health_client_test.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_health_client_test.reliable=(reliable);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_test_id+(((10)&0xff)<<8)+(((10)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_get_period_rsp_t* gecko_cmd_mesh_health_client_get_period(uint16 elem_index,uint16 server_address,uint16 appkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_get_period.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_get_period.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_get_period.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_get_period_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_set_period_rsp_t* gecko_cmd_mesh_health_client_set_period(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 period,uint8 reliable)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_set_period.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_set_period.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_set_period.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_set_period_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_get_attention_rsp_t* gecko_cmd_mesh_health_client_get_attention(uint16 elem_index,uint16 server_address,uint16 appkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_get_attention.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_get_attention.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_get_attention.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_get_attention_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_client_set_attention_rsp_t* gecko_cmd_mesh_health_client_set_attention(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 attention,uint8 reliable)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_client_set_attention.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_client_set_attention.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_health_client_set_attention.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_client_set_attention_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_server_set_fault_rsp_t* gecko_cmd_mesh_health_server_set_fault(uint16 elem_index,uint8 id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_server_set_fault.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_server_set_fault.id=(id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_server_set_fault_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_server_clear_fault_rsp_t* gecko_cmd_mesh_health_server_clear_fault(uint16 elem_index,uint8 id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_server_clear_fault.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_server_clear_fault.id=(id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_server_clear_fault_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_mesh_health_server_test_response_rsp_t* gecko_cmd_mesh_health_server_test_response(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint16 vendor_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_health_server_test_response.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_health_server_test_response.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_health_server_test_response.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_health_server_test_response.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_health_server_test_response_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_client_get_rsp_t* gecko_cmd_mesh_generic_client_get(uint16 model_id,uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 type)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_client_get.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get.type=(type);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_client_get_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_client_set_rsp_t* gecko_cmd_mesh_generic_client_set(uint16 model_id,uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 tid,uint32 transition,uint16 delay,uint16 flags,uint8 type,uint8 parameters_len, const uint8* parameters_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.tid=(tid);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.transition=SL_BT_SWAP32(transition);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.delay=SL_BT_SWAP16(delay);
    gecko_cmd_msg->data.cmd_mesh_generic_client_set.flags=SL_BT_SWAP16(flags);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_client_set_id+(((19+parameters_len)&0xff)<<8)+(((19+parameters_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_client_publish_rsp_t* gecko_cmd_mesh_generic_client_publish(uint16 model_id,uint16 elem_index,uint8 tid,uint32 transition,uint16 delay,uint16 flags,uint8 type,uint8 parameters_len, const uint8* parameters_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_client_publish.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_client_publish.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_client_publish.tid=(tid);
    gecko_cmd_msg->data.cmd_mesh_generic_client_publish.transition=SL_BT_SWAP32(transition);
    gecko_cmd_msg->data.cmd_mesh_generic_client_publish.delay=SL_BT_SWAP16(delay);
    gecko_cmd_msg->data.cmd_mesh_generic_client_publish.flags=SL_BT_SWAP16(flags);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_client_publish_id+(((15+parameters_len)&0xff)<<8)+(((15+parameters_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_client_get_params_rsp_t* gecko_cmd_mesh_generic_client_get_params(uint16 model_id,uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 type,uint8 parameters_len, const uint8* parameters_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_client_get_params.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get_params.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get_params.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_generic_client_get_params.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_client_get_params_id+(((10+parameters_len)&0xff)<<8)+(((10+parameters_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_client_init_rsp_t* gecko_cmd_mesh_generic_client_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_client_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_server_response_rsp_t* gecko_cmd_mesh_generic_server_response(uint16 model_id,uint16 elem_index,uint16 client_address,uint16 appkey_index,uint32 remaining,uint16 flags,uint8 type,uint8 parameters_len, const uint8* parameters_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_server_response.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_server_response.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_server_response.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_generic_server_response.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_generic_server_response.remaining=SL_BT_SWAP32(remaining);
    gecko_cmd_msg->data.cmd_mesh_generic_server_response.flags=SL_BT_SWAP16(flags);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_server_response_id+(((16+parameters_len)&0xff)<<8)+(((16+parameters_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_server_update_rsp_t* gecko_cmd_mesh_generic_server_update(uint16 model_id,uint16 elem_index,uint32 remaining,uint8 type,uint8 parameters_len, const uint8* parameters_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_server_update.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_server_update.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_server_update.remaining=SL_BT_SWAP32(remaining);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_server_update_id+(((10+parameters_len)&0xff)<<8)+(((10+parameters_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_server_publish_rsp_t* gecko_cmd_mesh_generic_server_publish(uint16 model_id,uint16 elem_index,uint8 type)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_server_publish.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_server_publish.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_server_publish.type=(type);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_server_publish_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_server_init_rsp_t* gecko_cmd_mesh_generic_server_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_server_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_generic_server_update_publish_property_id_rsp_t* gecko_cmd_mesh_generic_server_update_publish_property_id(uint16 model_id,uint16 elem_index,uint16 property)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_generic_server_update_publish_property_id.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_generic_server_update_publish_property_id.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_generic_server_update_publish_property_id.property=SL_BT_SWAP16(property);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_generic_server_update_publish_property_id_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_coex_set_options_rsp_t* gecko_cmd_coex_set_options(uint32 mask,uint32 options)
{
    ...
    gecko_cmd_msg->data.cmd_coex_set_options.mask=SL_BT_SWAP32(mask);
    gecko_cmd_msg->data.cmd_coex_set_options.options=SL_BT_SWAP32(options);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_coex_set_options_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_coex_get_counters_rsp_t* gecko_cmd_coex_get_counters(uint8 reset)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_coex_get_counters_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_nettx_rsp_t* gecko_cmd_mesh_test_get_nettx()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_nettx_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_nettx_rsp_t* gecko_cmd_mesh_test_set_nettx(uint8 count,uint8 interval)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_nettx_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_relay_rsp_t* gecko_cmd_mesh_test_get_relay()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_relay_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_relay_rsp_t* gecko_cmd_mesh_test_set_relay(uint8 enabled,uint8 count,uint8 interval)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_relay_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_adv_scan_params_rsp_t* gecko_cmd_mesh_test_set_adv_scan_params(uint16 adv_interval_min,uint16 adv_interval_max,uint8 adv_repeat_packets,uint8 adv_use_random_address,uint8 adv_channel_map,uint16 scan_interval,uint16 scan_window)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_adv_scan_params.adv_interval_min=SL_BT_SWAP16(adv_interval_min);
    gecko_cmd_msg->data.cmd_mesh_test_set_adv_scan_params.adv_interval_max=SL_BT_SWAP16(adv_interval_max);
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_adv_scan_params.scan_interval=SL_BT_SWAP16(scan_interval);
    gecko_cmd_msg->data.cmd_mesh_test_set_adv_scan_params.scan_window=SL_BT_SWAP16(scan_window);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_adv_scan_params_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_ivupdate_test_mode_rsp_t* gecko_cmd_mesh_test_set_ivupdate_test_mode(uint8 mode)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_ivupdate_test_mode_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_ivupdate_test_mode_rsp_t* gecko_cmd_mesh_test_get_ivupdate_test_mode()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_ivupdate_test_mode_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_segment_send_delay_rsp_t* gecko_cmd_mesh_test_set_segment_send_delay(uint8 delay)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_segment_send_delay_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_ivupdate_state_rsp_t* gecko_cmd_mesh_test_set_ivupdate_state(uint8 state)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_ivupdate_state_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_send_beacons_rsp_t* gecko_cmd_mesh_test_send_beacons()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_send_beacons_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_bind_local_model_app_rsp_t* gecko_cmd_mesh_test_bind_local_model_app(uint16 elem_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_bind_local_model_app.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_bind_local_model_app.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_test_bind_local_model_app.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_bind_local_model_app.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_bind_local_model_app_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_unbind_local_model_app_rsp_t* gecko_cmd_mesh_test_unbind_local_model_app(uint16 elem_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_unbind_local_model_app.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_unbind_local_model_app.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_test_unbind_local_model_app.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_unbind_local_model_app.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_unbind_local_model_app_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_add_local_model_sub_rsp_t* gecko_cmd_mesh_test_add_local_model_sub(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_add_local_model_sub_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_del_local_model_sub_rsp_t* gecko_cmd_mesh_test_del_local_model_sub(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_del_local_model_sub_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_add_local_model_sub_va_rsp_t* gecko_cmd_mesh_test_add_local_model_sub_va(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint8 sub_address_len, const uint8* sub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub_va.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_add_local_model_sub_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_add_local_model_sub_va_id+(((7+sub_address_len)&0xff)<<8)+(((7+sub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_del_local_model_sub_va_rsp_t* gecko_cmd_mesh_test_del_local_model_sub_va(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint8 sub_address_len, const uint8* sub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub_va.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_del_local_model_sub_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_del_local_model_sub_va_id+(((7+sub_address_len)&0xff)<<8)+(((7+sub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_local_model_sub_rsp_t* gecko_cmd_mesh_test_get_local_model_sub(uint16 elem_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_get_local_model_sub.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_get_local_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_get_local_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_local_model_sub_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_local_model_pub_rsp_t* gecko_cmd_mesh_test_set_local_model_pub(uint16 elem_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id,uint16 pub_address,uint8 ttl,uint8 period,uint8 retrans,uint8 credentials)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub.pub_address=SL_BT_SWAP16(pub_address);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_local_model_pub_id+(((14)&0xff)<<8)+(((14)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_local_model_pub_va_rsp_t* gecko_cmd_mesh_test_set_local_model_pub_va(uint16 elem_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id,uint8 ttl,uint8 period,uint8 retrans,uint8 credentials,uint8 pub_address_len, const uint8* pub_address_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub_va.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub_va.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_model_pub_va.model_id=SL_BT_SWAP16(model_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_local_model_pub_va_id+(((13+pub_address_len)&0xff)<<8)+(((13+pub_address_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_local_model_pub_rsp_t* gecko_cmd_mesh_test_get_local_model_pub(uint16 elem_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_get_local_model_pub.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_get_local_model_pub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_get_local_model_pub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_local_model_pub_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_local_heartbeat_subscription_rsp_t* gecko_cmd_mesh_test_set_local_heartbeat_subscription(uint16 subscription_source,uint16 subscription_destination,uint8 period_log)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_local_heartbeat_subscription.subscription_source=SL_BT_SWAP16(subscription_source);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_heartbeat_subscription.subscription_destination=SL_BT_SWAP16(subscription_destination);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_heartbeat_subscription.period_log=(period_log);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_local_heartbeat_subscription_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_local_heartbeat_subscription_rsp_t* gecko_cmd_mesh_test_get_local_heartbeat_subscription()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_local_heartbeat_subscription_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_local_heartbeat_publication_rsp_t* gecko_cmd_mesh_test_get_local_heartbeat_publication()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_local_heartbeat_publication_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_local_heartbeat_publication_rsp_t* gecko_cmd_mesh_test_set_local_heartbeat_publication(uint16 publication_address,uint8 count_log,uint8 period_log,uint8 ttl,uint16 features,uint16 publication_netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_local_heartbeat_publication.publication_address=SL_BT_SWAP16(publication_address);
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_local_heartbeat_publication.features=SL_BT_SWAP16(features);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_heartbeat_publication.publication_netkey_index=SL_BT_SWAP16(publication_netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_local_heartbeat_publication_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_local_config_rsp_t* gecko_cmd_mesh_test_set_local_config(uint16 id,uint16 netkey_index,uint8 value_len, const uint8* value_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_local_config.id=SL_BT_SWAP16(id);
    gecko_cmd_msg->data.cmd_mesh_test_set_local_config.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_local_config_id+(((5+value_len)&0xff)<<8)+(((5+value_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_local_config_rsp_t* gecko_cmd_mesh_test_get_local_config(uint16 id,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_get_local_config.id=SL_BT_SWAP16(id);
    gecko_cmd_msg->data.cmd_mesh_test_get_local_config.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_local_config_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_add_local_key_rsp_t* gecko_cmd_mesh_test_add_local_key(uint8 key_type,aes_key_128 key,uint16 key_index,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_add_local_key.key_index=SL_BT_SWAP16(key_index);
    gecko_cmd_msg->data.cmd_mesh_test_add_local_key.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_add_local_key_id+(((21)&0xff)<<8)+(((21)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_del_local_key_rsp_t* gecko_cmd_mesh_test_del_local_key(uint8 key_type,uint16 key_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_del_local_key.key_index=SL_BT_SWAP16(key_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_del_local_key_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_update_local_key_rsp_t* gecko_cmd_mesh_test_update_local_key(uint8 key_type,aes_key_128 key,uint16 key_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_update_local_key.key_index=SL_BT_SWAP16(key_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_update_local_key_id+(((19)&0xff)<<8)+(((19)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_sar_config_rsp_t* gecko_cmd_mesh_test_set_sar_config(uint32 incomplete_timer_ms,uint32 pending_ack_base_ms,uint32 pending_ack_mul_ms,uint32 wait_for_ack_base_ms,uint32 wait_for_ack_mul_ms,uint8 max_send_rounds)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_sar_config.incomplete_timer_ms=SL_BT_SWAP32(incomplete_timer_ms);
    gecko_cmd_msg->data.cmd_mesh_test_set_sar_config.pending_ack_base_ms=SL_BT_SWAP32(pending_ack_base_ms);
    gecko_cmd_msg->data.cmd_mesh_test_set_sar_config.pending_ack_mul_ms=SL_BT_SWAP32(pending_ack_mul_ms);
    gecko_cmd_msg->data.cmd_mesh_test_set_sar_config.wait_for_ack_base_ms=SL_BT_SWAP32(wait_for_ack_base_ms);
    gecko_cmd_msg->data.cmd_mesh_test_set_sar_config.wait_for_ack_mul_ms=SL_BT_SWAP32(wait_for_ack_mul_ms);
    gecko_cmd_msg->data.cmd_mesh_test_set_sar_config.max_send_rounds=(max_send_rounds);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_sar_config_id+(((21)&0xff)<<8)+(((21)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_element_seqnum_rsp_t* gecko_cmd_mesh_test_get_element_seqnum(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_get_element_seqnum.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_element_seqnum_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_adv_bearer_state_rsp_t* gecko_cmd_mesh_test_set_adv_bearer_state(uint8 state)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_adv_bearer_state_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_key_count_rsp_t* gecko_cmd_mesh_test_get_key_count(uint8 type)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_key_count_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_get_key_rsp_t* gecko_cmd_mesh_test_get_key(uint8 type,uint32 index,uint8 current)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_get_key.index=SL_BT_SWAP32(index);
    gecko_cmd_msg->data.cmd_mesh_test_get_key.current=(current);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_get_key_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_prov_get_device_key_rsp_t* gecko_cmd_mesh_test_prov_get_device_key(uint16 address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_prov_get_device_key.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_prov_get_device_key_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_prov_prepare_key_refresh_rsp_t* gecko_cmd_mesh_test_prov_prepare_key_refresh(aes_key_128 net_key,uint8 app_keys_len, const uint8* app_keys_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_prov_prepare_key_refresh_id+(((17+app_keys_len)&0xff)<<8)+(((17+app_keys_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_cancel_segmented_tx_rsp_t* gecko_cmd_mesh_test_cancel_segmented_tx(uint16 src_addr,uint16 dst_addr)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_cancel_segmented_tx.src_addr=SL_BT_SWAP16(src_addr);
    gecko_cmd_msg->data.cmd_mesh_test_cancel_segmented_tx.dst_addr=SL_BT_SWAP16(dst_addr);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_cancel_segmented_tx_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_iv_index_rsp_t* gecko_cmd_mesh_test_set_iv_index(uint32 iv_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_iv_index.iv_index=SL_BT_SWAP32(iv_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_iv_index_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_element_seqnum_rsp_t* gecko_cmd_mesh_test_set_element_seqnum(uint16 elem_index,uint32 seqnum)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_element_seqnum.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_set_element_seqnum.seqnum=SL_BT_SWAP32(seqnum);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_element_seqnum_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_test_set_model_option_rsp_t* gecko_cmd_mesh_test_set_model_option(uint16 elem_index,uint16 vendor_id,uint16 model_id,uint8 option,uint32 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_test_set_model_option.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_test_set_model_option.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_test_set_model_option.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_test_set_model_option.option=(option);
    gecko_cmd_msg->data.cmd_mesh_test_set_model_option.value=SL_BT_SWAP32(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_test_set_model_option_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_init_rsp_t* gecko_cmd_mesh_lpn_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_deinit_rsp_t* gecko_cmd_mesh_lpn_deinit()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_deinit_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_configure_rsp_t* gecko_cmd_mesh_lpn_configure(uint8 queue_length,uint32 poll_timeout)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_lpn_configure.poll_timeout=SL_BT_SWAP32(poll_timeout);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_configure_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_establish_friendship_rsp_t* gecko_cmd_mesh_lpn_establish_friendship(uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_lpn_establish_friendship.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_establish_friendship_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_poll_rsp_t* gecko_cmd_mesh_lpn_poll()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_poll_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_terminate_friendship_rsp_t* gecko_cmd_mesh_lpn_terminate_friendship()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_terminate_friendship_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_lpn_config_rsp_t* gecko_cmd_mesh_lpn_config(uint8 setting_id,uint32 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_lpn_config.value=SL_BT_SWAP32(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_lpn_config_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_friend_init_rsp_t* gecko_cmd_mesh_friend_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_friend_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_friend_deinit_rsp_t* gecko_cmd_mesh_friend_deinit()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_friend_deinit_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_cancel_request_rsp_t* gecko_cmd_mesh_config_client_cancel_request(uint32 handle)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_cancel_request.handle=SL_BT_SWAP32(handle);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_cancel_request_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_request_status_rsp_t* gecko_cmd_mesh_config_client_get_request_status(uint32 handle)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_request_status.handle=SL_BT_SWAP32(handle);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_request_status_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_default_timeout_rsp_t* gecko_cmd_mesh_config_client_get_default_timeout()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_default_timeout_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_default_timeout_rsp_t* gecko_cmd_mesh_config_client_set_default_timeout(uint32 timeout_ms,uint32 lpn_timeout_ms)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_default_timeout.timeout_ms=SL_BT_SWAP32(timeout_ms);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_default_timeout.lpn_timeout_ms=SL_BT_SWAP32(lpn_timeout_ms);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_default_timeout_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_add_netkey_rsp_t* gecko_cmd_mesh_config_client_add_netkey(uint16 enc_netkey_index,uint16 server_address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_add_netkey.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_netkey.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_netkey.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_add_netkey_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_remove_netkey_rsp_t* gecko_cmd_mesh_config_client_remove_netkey(uint16 enc_netkey_index,uint16 server_address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_netkey.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_netkey.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_netkey.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_remove_netkey_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_list_netkeys_rsp_t* gecko_cmd_mesh_config_client_list_netkeys(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_list_netkeys.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_netkeys.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_list_netkeys_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_add_appkey_rsp_t* gecko_cmd_mesh_config_client_add_appkey(uint16 enc_netkey_index,uint16 server_address,uint16 appkey_index,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_add_appkey.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_appkey.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_appkey.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_appkey.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_add_appkey_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_remove_appkey_rsp_t* gecko_cmd_mesh_config_client_remove_appkey(uint16 enc_netkey_index,uint16 server_address,uint16 appkey_index,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_appkey.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_appkey.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_appkey.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_appkey.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_remove_appkey_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_list_appkeys_rsp_t* gecko_cmd_mesh_config_client_list_appkeys(uint16 enc_netkey_index,uint16 server_address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_list_appkeys.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_appkeys.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_appkeys.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_list_appkeys_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_bind_model_rsp_t* gecko_cmd_mesh_config_client_bind_model(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_bind_model.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_bind_model.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_bind_model.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_bind_model.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_bind_model.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_bind_model.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_bind_model_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_unbind_model_rsp_t* gecko_cmd_mesh_config_client_unbind_model(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 appkey_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_unbind_model.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_unbind_model.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_unbind_model.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_unbind_model.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_unbind_model.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_unbind_model.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_unbind_model_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_list_bindings_rsp_t* gecko_cmd_mesh_config_client_list_bindings(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_list_bindings.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_bindings.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_bindings.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_bindings.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_bindings.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_list_bindings_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_model_pub_rsp_t* gecko_cmd_mesh_config_client_get_model_pub(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_model_pub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_model_pub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_model_pub.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_model_pub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_model_pub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_model_pub_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_model_pub_rsp_t* gecko_cmd_mesh_config_client_set_model_pub(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uint16 address,uint16 appkey_index,uint8 credentials,uint8 ttl,uint32 period_ms,uint8 retransmit_count,uint16 retransmit_interval_ms)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.period_ms=SL_BT_SWAP32(period_ms);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.retransmit_count=(retransmit_count);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub.retransmit_interval_ms=SL_BT_SWAP16(retransmit_interval_ms);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_model_pub_id+(((22)&0xff)<<8)+(((22)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_model_pub_va_rsp_t* gecko_cmd_mesh_config_client_set_model_pub_va(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uuid_128 address,uint16 appkey_index,uint8 credentials,uint8 ttl,uint32 period_ms,uint8 retransmit_count,uint16 retransmit_interval_ms)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.address=(address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.period_ms=SL_BT_SWAP32(period_ms);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.retransmit_count=(retransmit_count);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_pub_va.retransmit_interval_ms=SL_BT_SWAP16(retransmit_interval_ms);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_model_pub_va_id+(((36)&0xff)<<8)+(((36)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_add_model_sub_rsp_t* gecko_cmd_mesh_config_client_add_model_sub(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_add_model_sub_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_add_model_sub_va_rsp_t* gecko_cmd_mesh_config_client_add_model_sub_va(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uuid_128 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub_va.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub_va.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub_va.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub_va.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_add_model_sub_va.sub_address=(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_add_model_sub_va_id+(((25)&0xff)<<8)+(((25)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_remove_model_sub_rsp_t* gecko_cmd_mesh_config_client_remove_model_sub(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_remove_model_sub_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_remove_model_sub_va_rsp_t* gecko_cmd_mesh_config_client_remove_model_sub_va(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uuid_128 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub_va.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub_va.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub_va.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub_va.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_remove_model_sub_va.sub_address=(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_remove_model_sub_va_id+(((25)&0xff)<<8)+(((25)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_model_sub_rsp_t* gecko_cmd_mesh_config_client_set_model_sub(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uint16 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub.sub_address=SL_BT_SWAP16(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_model_sub_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_model_sub_va_rsp_t* gecko_cmd_mesh_config_client_set_model_sub_va(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id,uuid_128 sub_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub_va.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub_va.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub_va.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub_va.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub_va.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_model_sub_va.sub_address=(sub_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_model_sub_va_id+(((25)&0xff)<<8)+(((25)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_clear_model_sub_rsp_t* gecko_cmd_mesh_config_client_clear_model_sub(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_clear_model_sub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_clear_model_sub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_clear_model_sub.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_clear_model_sub.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_clear_model_sub.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_clear_model_sub_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_list_subs_rsp_t* gecko_cmd_mesh_config_client_list_subs(uint16 enc_netkey_index,uint16 server_address,uint8 element_index,uint16 vendor_id,uint16 model_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_list_subs.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_subs.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_subs.element_index=(element_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_subs.vendor_id=SL_BT_SWAP16(vendor_id);
    gecko_cmd_msg->data.cmd_mesh_config_client_list_subs.model_id=SL_BT_SWAP16(model_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_list_subs_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_heartbeat_pub_rsp_t* gecko_cmd_mesh_config_client_get_heartbeat_pub(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_heartbeat_pub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_heartbeat_pub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_heartbeat_pub_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_heartbeat_pub_rsp_t* gecko_cmd_mesh_config_client_set_heartbeat_pub(uint16 enc_netkey_index,uint16 server_address,uint16 destination_address,uint16 netkey_index,uint8 count_log,uint8 period_log,uint8 ttl,uint16 features)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_pub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_pub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_pub.destination_address=SL_BT_SWAP16(destination_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_pub.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_pub.features=SL_BT_SWAP16(features);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_heartbeat_pub_id+(((13)&0xff)<<8)+(((13)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_heartbeat_sub_rsp_t* gecko_cmd_mesh_config_client_get_heartbeat_sub(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_heartbeat_sub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_heartbeat_sub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_heartbeat_sub_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_heartbeat_sub_rsp_t* gecko_cmd_mesh_config_client_set_heartbeat_sub(uint16 enc_netkey_index,uint16 server_address,uint16 source_address,uint16 destination_address,uint8 period_log)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_sub.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_sub.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_sub.source_address=SL_BT_SWAP16(source_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_sub.destination_address=SL_BT_SWAP16(destination_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_heartbeat_sub.period_log=(period_log);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_heartbeat_sub_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_beacon_rsp_t* gecko_cmd_mesh_config_client_get_beacon(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_beacon.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_beacon.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_beacon_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_beacon_rsp_t* gecko_cmd_mesh_config_client_set_beacon(uint16 enc_netkey_index,uint16 server_address,uint8 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_beacon.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_beacon.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_beacon.value=(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_beacon_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_default_ttl_rsp_t* gecko_cmd_mesh_config_client_get_default_ttl(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_default_ttl.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_default_ttl.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_default_ttl_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_default_ttl_rsp_t* gecko_cmd_mesh_config_client_set_default_ttl(uint16 enc_netkey_index,uint16 server_address,uint8 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_default_ttl.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_default_ttl.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_default_ttl.value=(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_default_ttl_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_gatt_proxy_rsp_t* gecko_cmd_mesh_config_client_get_gatt_proxy(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_gatt_proxy.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_gatt_proxy.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_gatt_proxy_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_gatt_proxy_rsp_t* gecko_cmd_mesh_config_client_set_gatt_proxy(uint16 enc_netkey_index,uint16 server_address,uint8 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_gatt_proxy.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_gatt_proxy.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_gatt_proxy.value=(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_gatt_proxy_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_relay_rsp_t* gecko_cmd_mesh_config_client_get_relay(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_relay.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_relay.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_relay_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_relay_rsp_t* gecko_cmd_mesh_config_client_set_relay(uint16 enc_netkey_index,uint16 server_address,uint8 value,uint8 retransmit_count,uint16 retransmit_interval_ms)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_relay.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_relay.server_address=SL_BT_SWAP16(server_address);
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_relay.retransmit_interval_ms=SL_BT_SWAP16(retransmit_interval_ms);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_relay_id+(((8)&0xff)<<8)+(((8)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_network_transmit_rsp_t* gecko_cmd_mesh_config_client_get_network_transmit(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_network_transmit.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_network_transmit.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_network_transmit_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_network_transmit_rsp_t* gecko_cmd_mesh_config_client_set_network_transmit(uint16 enc_netkey_index,uint16 server_address,uint8 transmit_count,uint16 transmit_interval_ms)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_network_transmit.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_network_transmit.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_network_transmit.transmit_count=(transmit_count);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_network_transmit.transmit_interval_ms=SL_BT_SWAP16(transmit_interval_ms);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_network_transmit_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_identity_rsp_t* gecko_cmd_mesh_config_client_get_identity(uint16 enc_netkey_index,uint16 server_address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_identity.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_identity.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_identity.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_identity_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_identity_rsp_t* gecko_cmd_mesh_config_client_set_identity(uint16 enc_netkey_index,uint16 server_address,uint16 netkey_index,uint8 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_identity.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_identity.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_identity.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_identity.value=(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_identity_id+(((7)&0xff)<<8)+(((7)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_friend_rsp_t* gecko_cmd_mesh_config_client_get_friend(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_friend.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_friend.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_friend_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_set_friend_rsp_t* gecko_cmd_mesh_config_client_set_friend(uint16 enc_netkey_index,uint16 server_address,uint8 value)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_set_friend.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_friend.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_set_friend.value=(value);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_set_friend_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_lpn_polltimeout_rsp_t* gecko_cmd_mesh_config_client_get_lpn_polltimeout(uint16 enc_netkey_index,uint16 server_address,uint16 lpn_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_lpn_polltimeout.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_lpn_polltimeout.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_lpn_polltimeout.lpn_address=SL_BT_SWAP16(lpn_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_lpn_polltimeout_id+(((6)&0xff)<<8)+(((6)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_get_dcd_rsp_t* gecko_cmd_mesh_config_client_get_dcd(uint16 enc_netkey_index,uint16 server_address,uint8 page)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_get_dcd.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_dcd.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_config_client_get_dcd.page=(page);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_get_dcd_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_mesh_config_client_reset_node_rsp_t* gecko_cmd_mesh_config_client_reset_node(uint16 enc_netkey_index,uint16 server_address)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_config_client_reset_node.enc_netkey_index=SL_BT_SWAP16(enc_netkey_index);
    gecko_cmd_msg->data.cmd_mesh_config_client_reset_node.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_config_client_reset_node_id+(((4)&0xff)<<8)+(((4)&0x700)>>8));
...
static inline struct gecko_msg_l2cap_coc_send_connection_request_rsp_t* gecko_cmd_l2cap_coc_send_connection_request(uint8 connection,uint16 le_psm,uint16 mtu,uint16 mps,uint16 initial_credit)
{
    ...
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_request.le_psm=SL_BT_SWAP16(le_psm);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_request.mtu=SL_BT_SWAP16(mtu);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_request.mps=SL_BT_SWAP16(mps);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_request.initial_credit=SL_BT_SWAP16(initial_credit);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_l2cap_coc_send_connection_request_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_l2cap_coc_send_connection_response_rsp_t* gecko_cmd_l2cap_coc_send_connection_response(uint8 connection,uint16 cid,uint16 mtu,uint16 mps,uint16 initial_credit,uint16 result)
{
    ...
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_response.cid=SL_BT_SWAP16(cid);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_response.mtu=SL_BT_SWAP16(mtu);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_response.mps=SL_BT_SWAP16(mps);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_response.initial_credit=SL_BT_SWAP16(initial_credit);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_connection_response.result=SL_BT_SWAP16(result);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_l2cap_coc_send_connection_response_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_l2cap_coc_send_le_flow_control_credit_rsp_t* gecko_cmd_l2cap_coc_send_le_flow_control_credit(uint8 connection,uint16 cid,uint16 credits)
{
    ...
    gecko_cmd_msg->data.cmd_l2cap_coc_send_le_flow_control_credit.cid=SL_BT_SWAP16(cid);
    gecko_cmd_msg->data.cmd_l2cap_coc_send_le_flow_control_credit.credits=SL_BT_SWAP16(credits);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_l2cap_coc_send_le_flow_control_credit_id+(((5)&0xff)<<8)+(((5)&0x700)>>8));
...
static inline struct gecko_msg_l2cap_coc_send_disconnection_request_rsp_t* gecko_cmd_l2cap_coc_send_disconnection_request(uint8 connection,uint16 cid)
{
    ...
    gecko_cmd_msg->data.cmd_l2cap_coc_send_disconnection_request.cid=SL_BT_SWAP16(cid);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_l2cap_coc_send_disconnection_request_id+(((3)&0xff)<<8)+(((3)&0x700)>>8));
...
static inline struct gecko_msg_l2cap_coc_send_data_rsp_t* gecko_cmd_l2cap_coc_send_data(uint8 connection,uint16 cid,uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->data.cmd_l2cap_coc_send_data.cid=SL_BT_SWAP16(cid);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_l2cap_coc_send_data_id+(((4+data_len)&0xff)<<8)+(((4+data_len)&0x700)>>8));
...
static inline struct gecko_msg_cte_transmitter_set_dtm_parameters_rsp_t* gecko_cmd_cte_transmitter_set_dtm_parameters(uint8 cte_length,uint8 cte_type,uint8 switching_pattern_len, const uint8* switching_pattern_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_cte_transmitter_set_dtm_parameters_id+(((3+switching_pattern_len)&0xff)<<8)+(((3+switching_pattern_len)&0x700)>>8));
...
static inline struct gecko_msg_cte_transmitter_clear_dtm_parameters_rsp_t* gecko_cmd_cte_transmitter_clear_dtm_parameters()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_cte_transmitter_clear_dtm_parameters_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_cte_receiver_configure_rsp_t* gecko_cmd_cte_receiver_configure(uint8 flags)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_cte_receiver_configure_id+(((1)&0xff)<<8)+(((1)&0x700)>>8));
...
static inline struct gecko_msg_cte_receiver_set_dtm_parameters_rsp_t* gecko_cmd_cte_receiver_set_dtm_parameters(uint8 cte_length,uint8 cte_type,uint8 slot_durations,uint8 switching_pattern_len, const uint8* switching_pattern_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_cte_receiver_set_dtm_parameters_id+(((4+switching_pattern_len)&0xff)<<8)+(((4+switching_pattern_len)&0x700)>>8));
...
static inline struct gecko_msg_cte_receiver_clear_dtm_parameters_rsp_t* gecko_cmd_cte_receiver_clear_dtm_parameters()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_cte_receiver_clear_dtm_parameters_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_server_init_rsp_t* gecko_cmd_mesh_sensor_server_init(uint16 elem_index,uint8 descriptors_len, const uint8* descriptors_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_server_init.elem_index=SL_BT_SWAP16(elem_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_server_init_id+(((3+descriptors_len)&0xff)<<8)+(((3+descriptors_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_server_deinit_rsp_t* gecko_cmd_mesh_sensor_server_deinit(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_server_deinit.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_server_deinit_id+(((2)&0xff)<<8)+(((2)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_server_send_descriptor_status_rsp_t* gecko_cmd_mesh_sensor_server_send_descriptor_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint8 descriptors_len, const uint8* descriptors_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_descriptor_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_descriptor_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_descriptor_status.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_server_send_descriptor_status_id+(((8+descriptors_len)&0xff)<<8)+(((8+descriptors_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_server_send_status_rsp_t* gecko_cmd_mesh_sensor_server_send_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint8 sensor_data_len, const uint8* sensor_data_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_status.appkey_index=SL_BT_SWAP16(appkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_server_send_status_id+(((8+sensor_data_len)&0xff)<<8)+(((8+sensor_data_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_server_send_column_status_rsp_t* gecko_cmd_mesh_sensor_server_send_column_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 sensor_data_len, const uint8* sensor_data_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_column_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_column_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_column_status.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_column_status.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_column_status.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_server_send_column_status_id+(((10+sensor_data_len)&0xff)<<8)+(((10+sensor_data_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_server_send_series_status_rsp_t* gecko_cmd_mesh_sensor_server_send_series_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 sensor_data_len, const uint8* sensor_data_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_series_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_series_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_series_status.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_series_status.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_server_send_series_status.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_server_send_series_status_id+(((10+sensor_data_len)&0xff)<<8)+(((10+sensor_data_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_setup_server_send_cadence_status_rsp_t* gecko_cmd_mesh_sensor_setup_server_send_cadence_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 params_len, const uint8* params_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_cadence_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_cadence_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_cadence_status.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_cadence_status.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_cadence_status.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_setup_server_send_cadence_status_id+(((10+params_len)&0xff)<<8)+(((10+params_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_setup_server_send_settings_status_rsp_t* gecko_cmd_mesh_sensor_setup_server_send_settings_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 setting_ids_len, const uint8* setting_ids_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_settings_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_settings_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_settings_status.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_settings_status.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_settings_status.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_setup_server_send_settings_status_id+(((10+setting_ids_len)&0xff)<<8)+(((10+setting_ids_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_setup_server_send_setting_status_rsp_t* gecko_cmd_mesh_sensor_setup_server_send_setting_status(uint16 elem_index,uint16 client_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint16 setting_id,uint8 raw_value_len, const uint8* raw_value_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_setting_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_setting_status.client_address=SL_BT_SWAP16(client_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_setting_status.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_setting_status.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_setting_status.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->data.cmd_mesh_sensor_setup_server_send_setting_status.setting_id=SL_BT_SWAP16(setting_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_setup_server_send_setting_status_id+(((12+raw_value_len)&0xff)<<8)+(((12+raw_value_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_init_rsp_t* gecko_cmd_mesh_sensor_client_init()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_init_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_deinit_rsp_t* gecko_cmd_mesh_sensor_client_deinit()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_deinit_id+(((0)&0xff)<<8)+(((0)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_descriptor_rsp_t* gecko_cmd_mesh_sensor_client_get_descriptor(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_descriptor.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_descriptor.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_descriptor.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_descriptor.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_descriptor.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_descriptor_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_rsp_t* gecko_cmd_mesh_sensor_client_get(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_column_rsp_t* gecko_cmd_mesh_sensor_client_get_column(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 column_id_len, const uint8* column_id_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_column.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_column.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_column.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_column.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_column.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_column_id+(((10+column_id_len)&0xff)<<8)+(((10+column_id_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_series_rsp_t* gecko_cmd_mesh_sensor_client_get_series(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 column_ids_len, const uint8* column_ids_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_series.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_series.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_series.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_series.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_series.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_series_id+(((10+column_ids_len)&0xff)<<8)+(((10+column_ids_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_cadence_rsp_t* gecko_cmd_mesh_sensor_client_get_cadence(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_cadence.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_cadence.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_cadence.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_cadence.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_cadence.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_cadence_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_set_cadence_rsp_t* gecko_cmd_mesh_sensor_client_set_cadence(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint8 params_len, const uint8* params_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_cadence.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_cadence.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_cadence.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_cadence.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_cadence.property_id=SL_BT_SWAP16(property_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_set_cadence_id+(((10+params_len)&0xff)<<8)+(((10+params_len)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_settings_rsp_t* gecko_cmd_mesh_sensor_client_get_settings(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_settings.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_settings.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_settings.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_settings.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_settings.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_settings_id+(((9)&0xff)<<8)+(((9)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_get_setting_rsp_t* gecko_cmd_mesh_sensor_client_get_setting(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint16 setting_id)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_setting.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_setting.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_setting.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_setting.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_setting.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_get_setting.setting_id=SL_BT_SWAP16(setting_id);
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_get_setting_id+(((11)&0xff)<<8)+(((11)&0x700)>>8));
...
static inline struct gecko_msg_mesh_sensor_client_set_setting_rsp_t* gecko_cmd_mesh_sensor_client_set_setting(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 flags,uint16 property_id,uint16 setting_id,uint8 raw_value_len, const uint8* raw_value_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_setting.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_setting.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_setting.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_setting.flags=(flags);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_setting.property_id=SL_BT_SWAP16(property_id);
    gecko_cmd_msg->data.cmd_mesh_sensor_client_set_setting.setting_id=SL_BT_SWAP16(setting_id);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_mesh_sensor_client_set_setting_id+(((12+raw_value_len)&0xff)<<8)+(((12+raw_value_len)&0x700)>>8));
...
static inline struct gecko_msg_user_message_to_target_rsp_t* gecko_cmd_user_message_to_target(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32(gecko_cmd_user_message_to_target_id+(((1+data_len)&0xff)<<8)+(((1+data_len)&0x700)>>8));
